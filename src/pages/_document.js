    ...
    return (
      <Html lang={this.props.lang || 'en'}>
        <Head>
          ...
          <meta
            name="description"
            content="Support those on the ground, online"
          />
          ...
          <meta
            property="og:image"
            content="https://supportpeople.s3.eu-west-2.amazonaws.com/summary_large_image.png"
          />

          <meta property="twitter:card" content="/summary_large_image.png" />
          <meta
            property="twitter:url"
            content="https://supportpeople.online/"
          />
