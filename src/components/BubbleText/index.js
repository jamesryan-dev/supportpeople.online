...
function BubbleText(props) {
  ...
  return (
    <Bubble className="bubble">
      ...
      <strong>
        <p className="desktop">
          Please put https://supportpeople.online in your bio or in a Swipe Up
          story if you have over 10k followers
        </p>
        <p className="mobile">
          Please put https://supportpeople.online in your instagram or twitter
          bio
        </p>
      </strong>
    </Bubble>
